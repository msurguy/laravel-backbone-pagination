...
<body>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="in-place-pagination-using-backbone-js-laravel-shop-tutorial" target="_blank">Tutorial</a></li>
    ...
    <div class="container">
      ...
      <footer>
        <div class="row">
          <div class="col-md-12">
            Created by <a href="http://maxoffsky.com" target="_blank">Maks</a> | <a href="in-place-pagination-using-backbone-js-laravel-shop-tutorial" target="_blank">Tutorial</a>
          </div>
        </div>
      </footer>
